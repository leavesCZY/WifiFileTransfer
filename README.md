...
通过 Android 设备的 Wifi 个人热点，实现 Android 手机之间传输任意文件。理论上此实现方式不受系统版本的限制，只要
Android 手机支持开启 “Wifi 个人热点” 和 “连接 Wifi”，就可以在 Android 手机之间传输任意文件
...
4. 文件发送端先获取到 Socket 对应的 OutputStream，通过 ObjectOutputStream 将待发送的文件信息写入到
   OutputStream 中，以便让文件接收端知道该如何命名即将接收到的文件
